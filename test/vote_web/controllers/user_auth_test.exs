defmodule VoteWeb.UserAuthTest do
  use VoteWeb.ConnCase, async: true

  alias Vote.Accounts
  alias VoteWeb.UserAuth
  import Vote.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, VoteWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      VoteWeb.Endpoint.subscribe(live_socket_id)
